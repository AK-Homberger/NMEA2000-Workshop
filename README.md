...
Damit haben wir ein kleines NMEA2000-Netzwerk zum üben. Eigenlich besteht ein [NMEA2000-Netzwerk](https://de.wikipedia.org/wiki/NMEA_2000) aus einem Backbone-Kabel, dass an beiden Enden mit einem Wiederstand abgeschlossen ist. Vom Backbone können dann mehrere Stichleitungen zu den Geräten abgehen. Für unser Mini-Netzwerk ist das aber nicht weiter wichtig. der CAN-Bus ist so robust, dass es auch mit einer einfachen Direktverbindung von CAN-L und CAN-H funktioniert.
