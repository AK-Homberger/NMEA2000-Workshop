...
Im Geber ist, anders als im Datenblatt beschrieben, ein [Open-Collector-Ausgang](https://de.wikipedia.org/wiki/Open-Collector-Ausgang) verbaut. Daher reicht in ein einfacher [Pull-Up-Widerstand](https://de.wikipedia.org/wiki/Open_circuit#Pull-up) am Eingang des ESP32 aus (s. Definition "INPUT_PULLUP" für GPIO in setup()).
