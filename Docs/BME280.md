...
Im Gegensatz dazu gibt es auch PGN, die an einzelne Zieladressen gesendet werden können. Welche PGN Broadcast-PGNs sind, und welche auch an einzelne Zieladressen gesendet werden können, kann man leicht selbst herausfinden.
...
Alle in diesem Workshop verwendeten PGNs sind übrigens, wie überhaupt die meisten PGN, Broadcast-PGN.
