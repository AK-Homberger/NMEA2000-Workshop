...
Für unser PGN 130312 ist das Byte "FD", also größer als F0. Dieses PGN ist daher ein Broadcast-PGN und kann ausschließlich an alle Busteilnehmer gesendet werden.
