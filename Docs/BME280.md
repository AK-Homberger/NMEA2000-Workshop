...
Mit "Serial.printf("Temperature: %3.1f °C \n", Temperature);" geben wir die Temperatur formatiert an die serielle Schnittstelle aus. Informationen zur Formatierung mit printf() sind [hier](Serial.printf("Temperature: %3.1f °C \n", Temperature);
) zu finden.
