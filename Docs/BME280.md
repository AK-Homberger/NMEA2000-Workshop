...
Für unser obiges Beispiel 130312 ergibt sich dann "1FD08". Wichtig für die Unterscheidung, Broadcast oder nicht, ist das zweite Byte von links, also die beiden Ziffern nach der "1". Ist diese Zahl kleiner F0, dann handelt es sich um ein adressierbares PGN. Ist die Zahl größer oder gleich F0, dann ist es ein Broadcast-PGN.
