...
Das BME280-Modul ist eine Multi-Sensor-Modul, das Temperatur, Luftfeuchte und barometrischen Druck messen kann.
...
Das Beispielprogramm ist in der Programmierprache C und C++ geschrieben. Eine gutes Tutorial zur Programmiersprache ist übrigens [hier](http://manuel-jasch.de/post/einf%C3%BChrung-in-die-programmierung-mit-c-und-arduino/) zu finden.
...
Als erstes wird ein Objekt "bme" vom Typ "Adafruit_BME280" erstellt. Diese Objekt enhält die notwendigen Methoden/Funktionen zur Verwendung des BME280-Moduls.
...
Im nächsten Schritt setzen wir die Node-Adresse unseres Moduls. Als Standard-Adresse legen wir die Nummer 34 fest. Falls es zuvor einen Adress-Konflikt gegeben hatte (zwei Geräte wollten die gleiche Adresse 34 nutzen), handeln beide Geräte eindeutige Adressen aus. Es gehört zum NMEA2000-Standard, dass alle Geräte sich die letzte ausgehandelte Adresse merken und beim nächsten Start auch verwenden, um einen erneuten Adresskonflikt zu vermeiden.
...
Als nächtes sehen wir uns die Hilfsfunktionen etwas genauer an.
...
2. Mit NMEA2000.ParseMessages() geben wir der NMEA2000-Bibliothek regelmäßig die Gelegnheit, auf empfangene Nachrichten zu reagieren.
