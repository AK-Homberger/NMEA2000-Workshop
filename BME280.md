...
Als nächtes sehen wir uns die definierten Hilfsfunktionen etwas genauer an.
...
Das machen wir mit der Funktion CheckSourceAddressChange(). Hier prüfen wir, ob sich die eigene Node-Adresse aufgrund eine Adresskonflikts geändert hat (SourceAddress != NodeAddress). Falls sich die Adresse geändert hatte, speichern wir die neue Adresse im Flash-Speicherdes ESP32. Beim nächsten Start des Moduls wird die geänderte Adresse dann auch gleich wieder verwendet, um einen erneuten Adresskonflikt zu vermeiden.
...
2. Mit NMEA2000.ParseMessages() geben wir der NMEA2000-Bibliothek regelmäcßig die Gelegnheit, auf empfangene Nachrichten zu reagieren.
...
Das war es mit dem 1. Beispielprogramm. 
