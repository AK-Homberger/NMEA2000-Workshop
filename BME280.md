...
1. "static unsigned long SlowDataUpdated" wird definiert und durch "InitNextUpdate(SlowDataUpdatePeriod, TempSendOffset)" mit "millis() + Period + Offset" initialisirt.
2. 
