...
```
Mit den obigen Zeilen wird eine eindeutige ID (chipid[]) aus der WLAN-Netzwerkadresse (MAC = Media Access Code) des ESP32-Moduls berechnet.
...
Die konkreten Inhalte der Produkt-Information sin für die korrekte Funktion nicht relevant. Sie dienen nur der Information und können auf anderen Gereäten (z.B. NME2000 Plotter) angezeigt werden.
