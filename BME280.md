...
# Definition von globalen Variablen/Methoden

Kommen wir nun zur Definition von globalen Variablen und Methoden. Globale Variablen heißen "global", weil sie in allen Funktionen verwendet werden können. Im Gegensatz zu "globalen" sind "lokale" Varibalen, die in Funktionen definiert werden, nur in der jeweiligen Funktion bekannt und nuztbar.
...
Als nächstes wir die serielle Schnittstelle (USB) mit der Baud-Rate 115200 getartet. Das ist notwendig, um den Seriellen Monitor der Arduino-IDE nutzen zu können.
