...
Bei Gateways ist daher eine drahtlose Kopplung (WLAN) einer kabelgebundenen (USB-Seriell) vorzuziehen.

In den allermeisten Fällen wird es aber auch durch eine zusätzliche Massekopplung nicht zu Problemen kommen. Durch die [differentielle Datenübertragung](https://de.wikipedia.org/wiki/Symmetrische_Signal%C3%BCbertragung) ist der Bus sehr robust gegenüber Störungen durch Masseschleifen. Trotzdem sollte man diesen Zusammenhang verstehen.
