...
Aus unbekannten Gründen ist auf vielen CAN-Bus-Transceivern für den ESP32 ein 120 Ohm Widerstand mit eingebaut. Wie wir wissen, gehört der Widerstand nicht in die Geräte an den Enden der Stichleitungen, sondern an die Enden des Backbone-Kabels.
...
- Simrad/SimNet-Komponenten werden die Kabelfarben [hier](https://panbo.com/n2k-cable-mixing-not-a-big-woop/) erklärt. 
...
10. [Optional: Senden von Daten an einen SignalK-Server](https://github.com/AK-Homberger/NMEA2000-Workshop/blob/main/Docs/BME280-3-SignalK.md)
