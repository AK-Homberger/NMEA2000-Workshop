...
Ein standardisiertes NMEA2000(Light)-Kabel muss einen Mindestquerschnitt haben. Für das Signal sind dies AWG24 (0,201 qmm) und für die Versorgungsspannung AWG22 (0,318 qmm). Das obige Unitronic-Kabel erfüllt die Anforderungen für das Signal. Für die standardkonforme Stromversorgung ist es etwas zu dünn (0.22 qmm). Darauf muss man bei de Berechnung der maximalen Last, bei größeren Netztwerken, achten (s. LEN-Berechnung weiter unten).
