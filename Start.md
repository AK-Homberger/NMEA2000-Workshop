...
Ein standardisiertes NMEA2000(Light)-Kabel muss einen Mindestquerschnitt haben. Für das Signal sind dies AWG24 (0,201 mm²) und für die Versorgungsspannung AWG22 (0,318 mm²). Das obige Unitronic-Kabel erfüllt die Anforderungen für das Signal. Für die standardkonforme Stromversorgung ist es etwas zu dünn (0.22 mm²). Darauf muss man bei größeren Netzwerken und, der Berechnung der maximalen Last, achten (s. LEN-Berechnung weiter unten).
